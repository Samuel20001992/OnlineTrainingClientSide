    ...
    <div>
      ...
      >
        <SwiperSlide style={{width: '300px',height:'450px'}}>
           <Card style={{ margin: '20px', width: '300px',height:'400px', float: 'left', marginLeft:'100px'}}>
                    <CardMedia
                        component="img"
                        height="200"
        ...
        <SwiperSlide>
            <Card style={{ margin: '20px', width: '300px',height:'400px', float: 'left' }}>
                    <CardMedia
                        component="img"
                        height="200"
            image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQs0UBh6SYtyIhCLI6SFzPKkPZzpgycQDGdgA&usqp=CAU'
            alt="green iguana"
                    />
                   <CardContent>
                        <Typography gutterBottom component="div">
        ...
        <SwiperSlide>
            <Card style={{ margin: '20px', width: '300px',height:'400px', float: 'left' }}>
                    <CardMedia
                        component="img"
                        height="200"
            image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTB54J8AUS5ABLuHvJVyeFdSr7W9lhc_bJJ3Q&usqp=CAU'
            alt="green iguana"
                    />
                     <CardContent>
                        <Typography gutterBottom component="div">
